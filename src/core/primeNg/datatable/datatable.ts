...
export class RowExpansionLoader {
    ...
    constructor(public viewContainer: ViewContainerRef, public i18n: I18nService) { }
...
@Component({
    ...
    template: `
        <ng-template ngFor let-col [ngForOf]="columns" let-lastCol="last">
            <th #headerCell style="width: 50%;" [ngStyle]="col.style" [class]="col.styleClass" [style.display]="col.hidden ? 'none' : 'table-cell'" [style.white-space]="'nowrap'"  (click)="dt.sort($event,col)" [attr.colspan]="col.colspan" [attr.rowspan]="col.rowspan"
                [ngClass]="{'row col-sm-12 ui-state-default ui-unselectable-text':true, 'ui-sortable-column': col.sortable, 'ui-state-active': dt.isSorted(col), 'ui-resizable-column': dt.resizableColumns, 'ui-selection-column':col.selectionMode}" 
                ...
                <span class="ui-column-resizer spaceClass" *ngIf="dt.resizableColumns && ((dt.columnResizeMode == 'fit' && !lastCol) || dt.columnResizeMode == 'expand')" (mousedown)="dt.initColumnResize($event)"></span>
                <span class="row col-sm-12 ui-column-title spaceClass" *ngIf="!col.selectionMode&&!col.headerTemplate">{{col.header}}</span>
                <span class="row col-sm-12 ui-column-title spaceClass" *ngIf="col.headerTemplate">
                    <p-columnHeaderTemplateLoader [column]="col"></p-columnHeaderTemplateLoader>
                </span>
                <span class="ui-sortable-column-icon fa fa-fw fa-sort" *ngIf="col.sortable"
                     [ngClass]="{'fa-sort-desc': (dt.getSortOrder(col) == -1),'fa-sort-asc': (dt.getSortOrder(col) == 1)}"></span>
                <input style="position: relative;left: 10px;color: black;"  type="text" class="row col-sm-12 spaceClass ui-column-filter ui-inputtext ui-widget ui-state-default ui-corner-all" [attr.placeholder]="col.filterPlaceholder" *ngIf="col.filter&&!col.filterTemplate" [value]="dt.filters[col.field] ? dt.filters[col.field].value : ''" 
...
export class ColumnHeaders {
    ...
    constructor(@Inject(forwardRef(() => DataTable)) public dt: DataTable, public i18n: I18nService) { }
...
@Component({
    ...
    template: `
        <td *ngFor="let col of columns" [ngStyle]="col.style" [class]="col.styleClass"
            ...
            [ngClass]="{'ui-state-default':true}" [style.display]="col.hidden ? 'none' : 'table-cell'" [style.white-space]="'nowrap'">
...
@Component({
    ...
    template: `
        <ng-template ngFor let-rowData [ngForOf]="dt.dataToRender" let-even="even" let-odd="odd" let-rowIndex="index">
            <tr #rowGroupElement class="ui-widget-header ui-rowgroup-header" 
                *ngIf="dt.rowGroupMode=='subheader' && (rowIndex === 0||(dt.resolveFieldData(rowData,dt.groupField) !== dt.resolveFieldData(dt.dataToRender[rowIndex - 1], dt.groupField)))"
                (click)="dt.onRowGroupClick($event)" [ngStyle]="{'cursor': dt.sortableRowGroup ? 'pointer' : 'cursor'}">
            ...
            <tr #rowElement *ngIf="!dt.expandableRowGroups||dt.isRowGroupExpanded(rowData)" [class]="dt.getRowStyleClass(rowData,rowIndex)"
                ...
                <ng-template ngFor let-col [ngForOf]="columns" let-colIndex="index">
                    <td #cell *ngIf="!dt.rowGroupMode || (dt.rowGroupMode == 'subheader') ||
                        ...
                        [ngStyle]="col.style" [class]="col.styleClass" [style.display]="col.hidden ? 'none' : 'table-cell'" [style.white-space]="'nowrap'"
        ...
        <tr *ngIf="dt.isEmpty()" class="ui-widget-content">
            <td [attr.colspan]="dt.visibleColumns().length" class="ui-datatable-emptymessage">{{i18n.translate('NODATA')}}</td>
        </tr>
    `
    , styleUrls: ['./datatable.css']
})
...
export class ScrollableView implements AfterViewInit, AfterViewChecked, OnDestroy {
    ...
    constructor(@Inject(forwardRef(() => DataTable)) public dt: DataTable, public domHandler: DomHandler, public el: ElementRef, public renderer: Renderer, public i18n: I18nService) { }
...
@Component({
    ...
    <div [ngStyle]="style" [class]="styleClass" [style.width]="containerWidth"
            ...
            <div id="datatable" [ngClass]="tableresponsiveStyle()" #datatable class="ui-datatable-tablewrapper  table-responsive tableresponsive" *ngIf="!scrollable">
...
export class DataTable implements AfterViewChecked, AfterViewInit, AfterContentInit, OnInit, DoCheck, OnDestroy, BlockableUI {
    ...
    constructor(public el: ElementRef, public domHandler: DomHandler, public differs: IterableDiffers,
        ...
        public objectUtils: ObjectUtils, public i18n: I18nService) {
    }
    ...
    tableresponsiveStyle(){
        return{
            tableresponsive :this.i18n.getLanguage() =='ar'
        }
    }
