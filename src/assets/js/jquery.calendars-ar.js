...
(function($j) {
	'use strict';
	$j.calendars.calendars.gregorian.prototype.regionalOptions.ar = {
		name: 'Gregorian',
		epochs: ['BCE', 'CE'],
		...
		digits: $j.calendars.substituteDigits(['٠', '١', '٢', '٣', '٤', '٥', '٦', '٧', '٨', '٩']),
		dateFormat: 'dd/mm/yyyy',
		firstDay: 0,
		isRTL: true
	};
	if ($j.calendars.calendars.julian) {
		$j.calendars.calendars.julian.prototype.regionalOptions.ar =
			$j.calendars.calendars.gregorian.prototype.regionalOptions.ar;
	}
})(jQuery);
